...
# If the player goes straight to the Nether without dying, Unending Hell will trigger using the location trigger with the unending_hell_end advancement condition
