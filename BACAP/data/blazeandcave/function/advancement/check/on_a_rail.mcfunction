...
execute unless entity @s[predicate=blazeandcave:vehicle/minecart] run scoreboard players set @s bac_oar_eligible_x 0
execute unless entity @s[predicate=blazeandcave:vehicle/minecart] run scoreboard players set @s bac_oar_eligible_z 0
