...
execute if score hidden bac_settings matches 1 run scoreboard players set milestone bac_settings -1
...
execute if score hidden bac_settings matches -2 run scoreboard players set hidden bac_settings -1
