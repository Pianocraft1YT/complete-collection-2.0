...
public class items_stack_1_sulfur_cube {
    ...
    for (int i = 0; i < finals.size(); i++){
        for (String pat : patterns){
                    System.out.println("\""+pat.substring(pat.indexOf("\"id\"")+7, pat.length()-1) +"_"+ finals.get(i) + "\": {");
                    ...
                    System.out.println("\"minecraft:container\": [");
                        for (int j = 0; j < 26; j++){
                            ...
                            System.out.println("{\"slot\": " + j + ", \"item\": {\"id\": \"minecraft:" + finals.get(i) + "\", \"components\":{\"minecraft:sulfur_cube_content\":{" + pat + "}}}},");
                        }                                                                                                                       
                            System.out.println("{\"slot\": 26, \"item\": {\"id\": \"minecraft:" + finals.get(i) + "\", \"components\":{\"minecraft:sulfur_cube_content\":{" + pat + "}}}}");
                    System.out.println("]");
                    System.out.println("}");
                    System.out.println("}");
                    System.out.println("]");
