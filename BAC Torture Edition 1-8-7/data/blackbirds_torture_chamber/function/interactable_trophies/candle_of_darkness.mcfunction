execute as @a[predicate=blackbirds_torture_chamber:darkness_candle] run tag @s add darkness_check
execute as @a[predicate=blackbirds_torture_chamber:darkness_candle_offhand] run tag @s add darkness_check
...
execute as @a[predicate=!blackbirds_torture_chamber:darkness_candle,predicate=!blackbirds_torture_chamber:darkness_candle_offhand] run tag @s remove darkness_check